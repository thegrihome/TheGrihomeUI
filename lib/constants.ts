...
export const PROPERTY_TYPE_LABELS = {
  [PROPERTY_TYPES.SINGLE_FAMILY]: 'Villas',
  [PROPERTY_TYPES.CONDO]: 'Apartments',
  [PROPERTY_TYPES.TOWNHOUSE]: 'Houses',
  [PROPERTY_TYPES.LAND]: 'Lands',
  [PROPERTY_TYPES.LAND_RESIDENTIAL]: 'Residential Lands',
  [PROPERTY_TYPES.LAND_AGRICULTURE]: 'Agriculture Lands',
...
export const PROPERTY_TYPE_OPTIONS = [
  ...
  },
  {
    ...
    label: PROPERTY_TYPE_LABELS[PROPERTY_TYPES.LAND_RESIDENTIAL],
    icon: PROPERTY_TYPE_ICONS[PROPERTY_TYPES.LAND_RESIDENTIAL],
  },
  {
    value: PROPERTY_TYPES.LAND_AGRICULTURE,
    label: PROPERTY_TYPE_LABELS[PROPERTY_TYPES.LAND_AGRICULTURE],
