...
describe('General Discussions Page - Comprehensive Tests', () => {
  ...
  describe('Rendering and Initial State', () => {
    it('should render general discussions page with all components', () => {
      render(<GeneralDiscussionsPage cities={mockCities} totalPosts={330} statesCount={5} statesTotalPosts={100} />)
    ...
    it('should render page subtitle', () => {
      ...
      expect(screen.getByText(/Explore real estate discussions across major Indian cities/)).toBeInTheDocument()
    })
    ...
    it('should render singular thread for count of 1', () => {
      render(<GeneralDiscussionsPage cities={mockCities} totalPosts={1} statesCount={5} statesTotalPosts={100} />)
  ...
  describe('City List Rendering', () => {
    ...
    it('should link to city pages correctly', () => {
      const { container } = render(<GeneralDiscussionsPage cities={mockCities} totalPosts={330} statesCount={5} statesTotalPosts={100} />)

      const hydLink = container.querySelector('a[href="/forum/category/general-discussions/hyderabad"]')
      expect(hydLink).toBeInTheDocument()

      const chenLink = container.querySelector('a[href="/forum/category/general-discussions/chennai"]')
    ...
    it('should filter out other-cities from display', () => {
      ...
      render(<GeneralDiscussionsPage cities={citiesWithOther} totalPosts={340} statesCount={5} statesTotalPosts={100} />)
  ...
  describe('City Icons', () => {
    ...
    it('should render default icon for unknown city', () => {
      ...
      const { container } = render(<GeneralDiscussionsPage cities={unknownCity} totalPosts={150} statesCount={5} statesTotalPosts={100} />)
  ...
  describe('States and Union Territories Link', () => {
    ...
    it('should not render States & UTs link when no states', () => {
      render(<GeneralDiscussionsPage cities={mockCities} totalPosts={330} statesCount={0} statesTotalPosts={0} />)
    ...
    it('should render states description', () => {
      ...
      expect(screen.getByText(/Real estate discussions across all Indian states/)).toBeInTheDocument()
    })
  ...
  describe('SEO', () => {
    ...
    it('should render NextSeo with correct description', () => {
      ...
      const seo = screen.getByTestId('next-seo')
      expect(seo).toHaveAttribute('data-description', 'Browse real estate discussions by city across India on Grihome community forum')
    })
    ...
    it('should render NextSeo with correct canonical URL', () => {
      ...
      const seo = screen.getByTestId('next-seo')
      expect(seo).toHaveAttribute('data-canonical', 'https://grihome.vercel.app/forum/category/general-discussions')
    })
  })
  ...
  describe('Edge Cases', () => {
    it('should handle empty cities array', () => {
      const { container } = render(<GeneralDiscussionsPage cities={[]} totalPosts={0} statesCount={5} statesTotalPosts={100} />)
    ...
    it('should handle cities with zero posts', () => {
      ...
      render(<GeneralDiscussionsPage cities={zeroPostCity} totalPosts={0} statesCount={5} statesTotalPosts={100} />)
    ...
    it('should handle cities with no children', () => {
      ...
      render(<GeneralDiscussionsPage cities={noChildrenCity} totalPosts={80} statesCount={5} statesTotalPosts={100} />)
    ...
    it('should handle very large thread counts', () => {
      render(<GeneralDiscussionsPage cities={mockCities} totalPosts={999999} statesCount={5} statesTotalPosts={100} />)
  ...
  describe('All Cities Display', () => {
    it('should render Mumbai icon', () => {
      ...
      render(<GeneralDiscussionsPage cities={citiesWithMumbai} totalPosts={350} statesCount={5} statesTotalPosts={100} />)
    ...
    it('should render Delhi icon', () => {
      ...
      render(<GeneralDiscussionsPage cities={citiesWithDelhi} totalPosts={350} statesCount={5} statesTotalPosts={100} />)
    ...
    it('should render Kolkata icon', () => {
      ...
      render(<GeneralDiscussionsPage cities={citiesWithKolkata} totalPosts={350} statesCount={5} statesTotalPosts={100} />)
