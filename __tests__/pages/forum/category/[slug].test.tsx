...
describe('Category Page - Comprehensive Tests', () => {
  ...
  describe('Breadcrumb Navigation', () => {
    ...
    it('should render grandparent category in breadcrumb when available', () => {
      ...
      render(
        <CategoryPage
          category={categoryWithGrandparent}
          posts={mockPosts}
          totalCount={2}
          currentPage={1}
          totalPages={1}
  ...
  describe('Pagination', () => {
    ...
    it('should link to correct page number', () => {
      ...
      const nextLink = container.querySelector(
        'a[href="/forum/category/member-introductions?page=2"]'
      )
  ...
  describe('SEO', () => {
    ...
    it('should render default description when category description is null', () => {
      ...
      expect(seo).toHaveAttribute(
        'data-description',
        'Discussion forum for Member Introductions on Grihome'
      )
    })
    ...
    it('should render NextSeo with correct canonical URL', () => {
      ...
      expect(seo).toHaveAttribute(
        'data-canonical',
        'https://grihome.vercel.app/forum/category/member-introductions'
      )
    })
  })
